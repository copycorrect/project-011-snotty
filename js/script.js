let portfolioNavLists = document.querySelectorAll(".portfolio-nav-list");
let portfolioItems = document.querySelectorAll(".portfolio-item");

portfolioNavLists.forEach(function (item) {
  item.addEventListener("click", function () {
    portfolioNavLists.forEach(function (i) {
...
let rates = document.querySelectorAll(".money-rate");
let moneyHeader = document.querySelectorAll(".included");

moneyHeader.forEach(function (item, i) {
  item.addEventListener("click", function () {
    rates[i].classList.toggle("opened");
  });
});

let nav = document.querySelector(".nav-list");
let icon = document.querySelector(".iconNav");
let navList = document.querySelectorAll(".nav-list-item");

icon.addEventListener("click", function () {
  nav.classList.toggle("nav-list-active");
  icon.classList.toggle("iconNavDeactive");
});
...
navList.forEach(function (item) {
  item.addEventListener("click", function () {
    window.scrollTo({
      top:
        document.querySelector("#" + item.dataset.name).offsetTop -
